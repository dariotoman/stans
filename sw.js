const CORE_CACHE = 'stans-core-v7';
...
self.addEventListener('fetch', event => {
  ...
  if (url.hostname.endsWith('basemaps.cartocdn.com') || url.hostname.endsWith('opentopomap.org') || url.hostname.endsWith('arcgisonline.com')) {
